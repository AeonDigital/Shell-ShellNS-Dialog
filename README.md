...
``Shell Namespace Dialog`` provides functions for standard message interface 
...
"https://raw.githubusercontent.com/AeonDigital/Shell-ShellNS-Dialog/refs/heads/main/standalone.sh"
